...
image_icon = PhotoImage(file="logo.ico")
root.iconphoto(False,image_icon)

Round_box=PhotoImage(file="Rounded Rectangle 1_try1.png")
Label(root,image=Round_box,bg="#C8BFE7").place(x=10,y=110)

label1=Label(root, text="Temprature", font=("Helvetica", 11), fg="white", bg="#203243")
label1.place(x=15,y=120)
...
myimage=Label(image=Search_image,bg="#C8BFE7")
...
clock=Label(root,font=("Helvetica",30,'bold'),fg="white",bg="#C8BFE7")
clock.place(x=30,y=20)

timezone=Label(root,font=("Helvetica",18,'bold'),fg="white",bg="#C8BFE7")
timezone.place(x=700,y=20)

long_lat=Label(root,font=("Helvetica",10),fg="white",bg="#C8BFE7")
